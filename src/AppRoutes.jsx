...
const AddListingProduct = lazy(() =>
  import("./pages/listing/AddListingProduct")
);
...
const WarehouseOnboarding = lazy(() =>
  import("./pages/inventory/WarehouseOnboarding")
);
// order
...
const SettlementDashboard = lazy(() =>
  import("./pages/payment/SettlementDashboard")
);
