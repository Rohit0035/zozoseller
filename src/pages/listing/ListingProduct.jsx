...
const allColumns = [
  ...
  { name: 'Product Details', selector: row => row.productDetails, sortable: true },
  { name: 'Listing Price', selector: row => row.listingPrice, sortable: true, right: true },
  { name: 'Benchmark Price', selector: row => row.benchmarkPrice, sortable: true, right: true },
          ...
          <div className="d-flex align-items-end justify-content-end">
            <div className="position-relative me-2">
              ...
              {sortDropdownOpen && (
                ...
                >
                  <div className="dropdown-item" onClick={() => handleSortSelect('title', 'desc')}>
                    Product Title (DESC)
                  </div>
                  <div className="dropdown-item" onClick={() => handleSortSelect('created')}>
                    Creation Time
                  </div>
                  <div className="dropdown-item" onClick={() => handleSortSelect('updated')}>
                    Update Time
                  </div>
                  <div className="dropdown-item" onClick={() => handleSortSelect('sales')}>
                    Sales (Default)
                  </div>
                </div>
              )}
