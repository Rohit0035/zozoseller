...
const allColumns = [
  ...
  { name: 'Reason For Processing', selector: row => row.reason, sortable: true },
  { name: 'Amount', selector: row => row.amount, sortable: true, right: true },
  { name: 'Dispatch By Date', selector: row => row.dispatchByDate, sortable: true },
...
const OrdersUnderProcessingList = () => {
  ...
  const filteredData = demoProcessingOrders
    .filter(item =>
            ...
            <div className="position-relative me-2">
              ...
              {sortDropdownOpen && (
                <div className="position-absolute bg-white border rounded shadow-sm mt-1 p-2" style={{ width: '180px', zIndex: 1000 }}>
                  ...
                  <div className="dropdown-item" onClick={() => handleSortSelect('dispatchByDate')}>Dispatch By Date</div>
