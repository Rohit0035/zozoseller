...
const demoPendingServices = [
  {
    id: 1,
    orderId: 'PS-5001',
    productInfo: 'iPhone 14 - 128GB - Black',
    amount: '$799',
    serviceDetails: 'Screen Replacement',
  ...
  },
  {
    ...
    amount: '$699',
    serviceDetails: 'Battery Replacement',
  ...
  },
  {
    ...
    amount: '$999',
    serviceDetails: 'Keyboard Repair',
    status: 'Pending Service',
  },
  {
    id: 4,
    ...
    amount: '$850',
    serviceDetails: 'Software Update',
...
const allColumns = [
  ...
  { name: 'Service Details', selector: row => row.serviceDetails, sortable: true },
...
const PendingServicesList = () => {
  ...
  const filteredData = demoPendingServices
    .filter(item =>
            ...
            <div className="position-relative me-2">
              ...
              {sortDropdownOpen && (
                <div className="position-absolute bg-white border rounded shadow-sm mt-1 p-2" style={{ width: '180px', zIndex: 1000 }}>
                  ...
                  <div className="dropdown-item" onClick={() => handleSortSelect('serviceDetails')}>Service Details</div>
