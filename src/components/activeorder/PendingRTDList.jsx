...
const allColumns = [
  ...
  { name: 'Dispatch By Date', selector: row => row.dispatchDate, sortable: true },
...
const PendingRTDList = () => {
  ...
  const filteredData = demoRTDOrders
    .filter(item =>
            ...
            <div className="position-relative me-2">
              ...
              {sortDropdownOpen && (
                <div className="position-absolute bg-white border rounded shadow-sm mt-1 p-2" style={{ width: '180px', zIndex: 1000 }}>
                  ...
                  <div className="dropdown-item" onClick={() => handleSortSelect('dispatchDate')}>Dispatch Date</div>
