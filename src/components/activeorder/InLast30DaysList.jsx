...
const allColumns = [
  ...
  { name: 'Dispatch By Details', selector: row => row.dispatchByDetails, sortable: true },
  { name: 'Status', selector: row => row.status, sortable: true },
];

const presets = {
  'Default View': ['Order ID', 'Product Information', 'Amount'],
  'Full View': allColumns.map(col => col.name),
};

const InLast30DaysList = () => {
  ...
  const filteredData = demoLast30DaysOrders
    .filter(item =>
        ...
        <Col md="6">
          <div className="d-flex align-items-end justify-content-end">
            ...
            <div className="position-relative me-2">
              <button className="btn btn-outline-secondary btn-sm" onClick={() => setSortDropdownOpen(!sortDropdownOpen)}>
              ...
              {sortDropdownOpen && (
                <div className="position-absolute bg-white border rounded shadow-sm mt-1 p-2" style={{ width: '180px', zIndex: 1000 }}>
                  <div className="dropdown-item" onClick={() => handleSortSelect('orderId')}>Order ID</div>
                  <div className="dropdown-item" onClick={() => handleSortSelect('dispatchByDetails')}>Dispatch By Details</div>
            ...
            {/* Customize Columns */}
            <div className="position-relative me-2">
              <button className="btn btn-outline-primary btn-sm" onClick={() => setDropdownOpen(!dropdownOpen)}>
            ...
            <CSVLink
              ...
              filename="orders_last_30_days.csv"
...
export default InLast30DaysList;
