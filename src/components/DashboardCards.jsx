            ...
            <CardBody>
              ...
              <div className="mt-3 p-3 border rounded text-center bg-light">
                ...
                <p className="mb-0 small">
                  Check key metrics and benefits to grow your business
                </p>
          ...
          <Card className="flex-fill h-100  border-0">
            <CardBody>
              ...
              <ListGroup flush>
                ...
                >
                  <span>
                    <FaTshirt className="me-2 text-info" />Fashion Trends
                  </span>
                  <span>
                    {">"}
                  </span>
                ...
                <ListGroupItem
                  tag={Link}
                  to="/dhamaka-selection"
                  className="d-flex align-items-center justify-content-between"
                  action
                >
                  <span>
                    <FaFire className="me-2 text-danger" />Dhamaka Selection
                  </span>
                  <span>
                    {">"}
                  </span>
                ...
                >
                  <span>
                    <FaSearch className="me-2 text-warning" />Search Trends
                  </span>
                  <span>
                    {">"}
                  </span>
                ...
                >
                  <span>
                    <FaStar className="me-2 text-primary" />Bestsellers
                  </span>
                  <span>
                    {">"}
                  </span>
          ...
          <Card className="flex-fill h-100  border-0">
            <CardBody>
              <div className="d-flex align-items-center justify-content-between mb-3">
                <h5 className="mb-0">
                  <FaVideo className="me-1 text-dark" /> Video Guides
                </h5>
              ...
              >
                <SwiperSlide>
                  <div
                    ...
                    onClick={() =>
                      handleVideoClick(
                        "https://www.youtube.com/watch?v=ScsH0mFVpB4"
                      )}
                  >
                    <Row>
                      <Col>
                        <img
                          src="https://i.ytimg.com/vi_webp/ScsH0mFVpB4/maxresdefault.webp"
                          alt="Video 1"
                      ...
                      <Col>
                        ...
                        <p className="mb-0 small">
                          Know about Prohibited and Restricted Items
                        </p>
                      </Col>
                    </Row>
                  </div>
                ...
                <SwiperSlide>
                  ...
                  >
                    <img
                      src="https://via.placeholder.com/300x100?text=Video+2"
                      alt="Video 2"
                      className="img-fluid mb-2"
                    />
                    <span className="badge bg-warning text-dark me-2">
              ...
              <Button color="link" size="sm" className="mt-2 p-0">
                ▶ View More
              </Button>
            </CardBody>
          </Card>
